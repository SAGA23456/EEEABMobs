...
public abstract class EntityImmortal extends EEEABMobLibrary implements GlowEntity {
    ...
    protected void registerGoals() {
        super.registerGoals();
        this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, IronGolem.class, 0, true, false, null));//Only test
        this.targetSelector.addGoal(4, new NearestAttackableTargetGoal<>(this, EntityTestllager.class, 0, true, false, null));//Only test
    }
