package com.EEEAB.EEEABMobs.client.particle.util;

import com.EEEAB.EEEABMobs.client.render.EERenderType;
...
//Edited from https://github.com/BobMowzie/MowziesMobs/blob/master/src/main/java/com/bobmowzie/mowziesmobs/client/particle/util/AdvancedParticleBase.java base code
@OnlyIn(Dist.CLIENT)
    ...
    public void render(VertexConsumer buffer, Camera renderInfo, float partialTicks) {
        ...
        if (rotation instanceof ParticleRotation.FaceCamera faceCameraRot) {
            ...
            if (faceCameraRot.faceCameraAngle == 0.0F && faceCameraRot.prevFaceCameraAngle == 0.0F) {
                ...
                quaternion.rotateZ(Mth.lerp(partialTicks, faceCameraRot.prevFaceCameraAngle, faceCameraRot.faceCameraAngle));
