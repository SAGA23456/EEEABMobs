package com.EEEAB.EEEABMobs.client.render;
...
@OnlyIn(Dist.CLIENT)
public class EERenderType extends RenderType {
    public EERenderType(String name, VertexFormat vertexFormat, VertexFormat.Mode mode, int bufferSizeIn, boolean useDelegateIn, boolean needsSortingIn, Runnable setupTaskIn, Runnable clearTaskIn) {
